			...
			case 1: 
				if ( a < b )
				{
					...
					System.out.printf("%nThe number genarated are %d %n The number of even integers is %d %n The number of odd integers is %d %n The average is %.1f " , counter , even , odd , average );
					 ...
					 JOptionPane.showMessageDialog(null , "The number generated are " + counter);
					 JOptionPane.showMessageDialog(null , "The number of even is " + even);
					 JOptionPane.showMessageDialog(null , "The number of odd is " + odd);
...
2.  Decrement
Choose an option :2
Enter the decrement factor: 1
The numbers are: 13 12 11 10 9 8 7 6 5 4 3 2 
The number genarated are 12 
The number of even integers is 6 
The number of odd integers is 6 
The average is 7.5
*/ 